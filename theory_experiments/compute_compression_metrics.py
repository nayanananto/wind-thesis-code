...
METADATA_PATH = ROOT / "data" / "metadata" / "kbos_5min_phase_semantic_build.json"
RAW_PATH = ROOT / "data" / "noaa_5min" / "KBOS_2024_5min.parquet"
ENCODER_PATH = ROOT / "artifacts" / "semantic_encoder" / "kbos_5min_phase_encoder.joblib"
OUT = ROOT / "results" / "5min_two_seed_experiments"
